    ...
    return html.Div(
        ...
        children=[
            html.Div(
                id="banner-text",
                children=[
                    html.H5("SEG-TEF Dashboard"),
                    html.H6("Breakdown Logs and Reporting"),
                ],
            ),
            ...
            html.Div(
                id="banner-Img",
                children=[
                    html.Img(id="logo", src=app.get_asset_url("seg.jpg")),
            ...
            dcc.Tabs(
                ...
                children=[
                    ...
                    dcc.Tab(
                        ...
                        label="Breakdown Log Report dashboard",
                        value="tab2",
                        className="custom-tab",
                        selected_className="custom-tab--selected",
                    ),
